...
export type RootQueryPatternArgs = {
  id: Scalars['ID']['input'];
};
...
export type RootQueryAllPatternArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
  sort?: InputMaybe<Array<PatternSorting>>;
  where?: InputMaybe<PatternFilter>;
};
